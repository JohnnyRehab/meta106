        ...
        return Marionette.ItemView.extend({
            ...
            handleMidi: function(e) {
                ...
                if(type === 'CC') {
                    ...
                    this.midiChannel.vent.trigger('message', {
                        type: 'pitchBend',
                        value: this.getPitchBendValue(e.data)
                    });
                }
            },
            
            // 14-bit pitch-bend value (LSB in data[1], MSB in data[2]),
            // centered at 8192, normalized to -1..+1.
            getPitchBendValue: function(data) {
                var raw = (data[2] << 7) | data[1];
